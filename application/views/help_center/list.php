...
<div id="content" class="w">
	<div class="s_tl">当前位置：<a href="<?php echo $this->config->main_base_url;?>">首页</a><code class="lr3">></code><a href="<?php echo $this->config->help_url.'/Help_center/help_list';?>">帮助中心</a></div>
	<div class="ubg">
		<div class="u_l left">
