...
<div id="header">
    <div class="w">
        ...
        <div id="search" class="search left">
            <form action="<?php echo $this->config->main_base_url;?>" method="get" class="ov">
                ...
                <p class="hotw">
                	<a target="_blank" href="<?php echo $this->config->main_base_url;?>"><em class="red">土豪都在玩</em></a>
                	<em class="vline">|</em>
                	<a target="_blank" href="<?php echo $this->config->main_base_url;?>">飞机杯秒杀</a>
                	<em class="vline">|</em>
                	<a target="_blank" href="<?php echo $this->config->main_base_url;?>">男性自慰</a>
                	<em class="vline">|</em>
                	<a target="_blank" href="<?php echo $this->config->main_base_url;?>">延时助情</a>
                	<em class="vline">|</em>
                	<a target="_blank" href="<?php echo $this->config->main_base_url;?>">女性自慰</a>
                	<em class="vline">|</em>
                	<a target="_blank" href="<?php echo $this->config->main_base_url;?>">性用品</a>
                </p>
            </form>
            <div id="s_box"></div>
        </div>
